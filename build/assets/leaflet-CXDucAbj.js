import { r as B, v as ni } from "./react-CV3HRGEF.js";
import { c as es, g as is } from "./common-5dK6VpSw.js";
var oi = { exports: {} };
/* @preserve
 ...
 */ (function (m, f) {
  (function (h, p) {
    ...
    function ai(t) {
      var e = +new Date(),
        i = Math.max(0, 16 - (e - ri));
      return (ri = e + i), window.setTimeout(t, i);
    }
    var Pe = window.requestAnimationFrame || xe("RequestAnimationFrame") || ai,
      hi =
        window.cancelAnimationFrame ||
        xe("CancelAnimationFrame") ||
        xe("CancelRequestAnimationFrame") ||
        function (t) {
    ...
    (ut.extend = function (t) {
      ...
      return (
        ...
        t.includes && (zn(t.includes), d.apply(null, [n].concat(t.includes))),
        d(n, t),
        delete n.statics,
        delete n.includes,
        n.options && ((n.options = i.options ? R(i.options) : {}), d(n.options, t.options)),
        (n._initHooks = []),
    ...
    var Y = {
      ...
      fire: function (t, e, i) {
        ...
        var n = d({}, e, { type: t, target: this, sourceTarget: (e && e.sourceTarget) || this });
        if (this._events) {
    ...
    Z.prototype = {
      ...
      contains: function (t) {
        var e, i;
        return (
          typeof t[0] == "number" || t instanceof y ? (t = g(t)) : (t = q(t)),
      ...
      pad: function (t) {
        ...
        return q(g(e.x - n, e.y - o), g(i.x + n, i.y + o));
      },
      equals: function (t) {
    ...
    j.prototype = {
      extend: function (t) {
        ...
        } else return t ? this.extend(b(t) || N(t)) : this;
        return (
          !e && !i
            ? ((this._southWest = new z(n.lat, n.lng)), (this._northEast = new z(o.lat, o.lng)))
      ...
      pad: function (t) {
        ...
        return new j(new z(e.lat - n, e.lng - o), new z(i.lat + n, i.lng + o));
      },
      getCenter: function () {
      ...
      contains: function (t) {
        typeof t[0] == "number" || t instanceof z || "lat" in t ? (t = b(t)) : (t = N(t));
        var e = this._southWest,
          i = this._northEast,
          n,
          o;
        return (
          t instanceof j ? ((n = t.getSouthWest()), (o = t.getNorthEast())) : (n = o = t),
    ...
    var lt = {
        ...
        wrapLatLngBounds: function (t) {
          ...
          var s = t.getSouthWest(),
            r = t.getNorthEast(),
            a = new z(s.lat - n, s.lng - o),
            u = new z(r.lat - n, r.lng - o);
          return new j(a, u);
        },
      },
      mt = d({}, lt, {
    ...
    function fi(t, e) {
      ...
      for (n = 0, s = t.length; n < s; n++) {
        for (a = t[n], o = 0, r = a.length; o < r; o++) (u = a[o]), (i += (o ? "L" : "M") + u.x + " " + u.y);
        i += e ? (_.svg ? "z" : "x") : "";
      }
      return i || "M0 0";
    }
    var Me = document.documentElement.style,
      te = "ActiveXObject" in window,
      kn = te && !document.addEventListener,
      di = "msLaunchUri" in navigator && !("documentMode" in document),
      Ce = ot("webkit"),
      _i = ot("android"),
      mi = ot("android 2") || ot("android 3"),
      On = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
      Zn = _i && ot("Google") && On < 537 && !("AudioNode" in window),
      Se = !!window.opera,
      pi = !di && ot("chrome"),
      vi = ot("gecko") && !Ce && !Se && !te,
      In = !pi && ot("safari"),
      gi = ot("phantom"),
      yi = "OTransition" in Me,
      An = navigator.platform.indexOf("Win") === 0,
      wi = te && "transition" in Me,
      ze = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !mi,
      xi = "MozPerspective" in Me,
      Bn = !window.L_DISABLE_3D && (wi || ze || xi) && !yi && !gi,
      Nt = typeof orientation < "u" || ot("mobile"),
      Rn = Nt && Ce,
      Nn = Nt && ze,
      Pi = !window.PointerEvent && window.MSPointerEvent,
      Li = !!(window.PointerEvent || Pi),
      Ti = "ontouchstart" in window || !!window.TouchEvent,
      Dn = !window.L_NO_TOUCH && (Ti || Li),
      Hn = Nt && Se,
      Fn = Nt && vi,
      Wn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1,
      Un = (function () {
        var t = !1;
        try {
      ...
      Ee = !!(document.createElementNS && ci("svg").createSVGRect),
      Vn =
        !!Ee &&
        (function () {
      ...
      jn = navigator.platform.indexOf("Mac") === 0,
      Kn = navigator.platform.indexOf("Linux") === 0;
    function ot(t) {
    ...
    var _ = {
      ...
      bi = _.msPointer ? "MSPointerDown" : "pointerdown",
      Mi = _.msPointer ? "MSPointerMove" : "pointermove",
      Ci = _.msPointer ? "MSPointerUp" : "pointerup",
      Si = _.msPointer ? "MSPointerCancel" : "pointercancel",
      ke = { touchstart: bi, touchmove: Mi, touchend: Ci, touchcancel: Si },
      zi = { touchstart: to, touchmove: ee, touchend: ee, touchcancel: ee },
      Mt = {},
      Ei = !1;
    function Yn(t, e, i) {
      return (
        e === "touchstart" && Qn(),
        zi[e]
          ? ((i = zi[e].bind(this, i)), t.addEventListener(ke[e], i, !1), i)
    ...
    function Qn() {
      Ei ||
        (document.addEventListener(bi, Jn, !0),
        document.addEventListener(Mi, $n, !0),
        document.addEventListener(Ci, ki, !0),
        document.addEventListener(Si, ki, !0),
        (Ei = !0));
    }
    function ee(t, e) {
    ...
    function to(t, e) {
      e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && W(e), ee(t, e);
    }
    function eo(t) {
      var e = {},
        i,
    ...
    var Oe = oe(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]),
      Dt = oe(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]),
      Oi = Dt === "webkitTransition" || Dt === "OTransition" ? Dt + "End" : "transitionend";
    function Zi(t) {
    ...
    function x(t, e) {
      if (t.classList !== void 0) for (var i = ht(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
      else if (!Ze(t, e)) {
        var s = ne(t);
        Ie(t, (s ? s + " " : "") + e);
      }
    ...
    function A(t, e) {
      t.classList !== void 0 ? t.classList.remove(e) : Ie(t, U((" " + ne(t) + " ").replace(" " + e + " ", " ")));
    }
    function Ie(t, e) {
    ...
    function $(t, e) {
      "opacity" in t.style ? (t.style.opacity = e) : "filter" in t.style && so(t, e);
    }
    function so(t, e) {
      var i = !1,
      ...
      (e = Math.round(e * 100)),
        i ? ((i.Enabled = e !== 100), (i.Opacity = e)) : (t.style.filter += " progid:" + n + "(opacity=" + e + ")");
    }
    function oe(t) {
    ...
    function xt(t, e, i) {
      var n = e || new y(0, 0);
      t.style[Oe] =
        (_.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") +
        (i ? " scale(" + i + ")" : "");
    }
    function D(t, e) {
    ...
    if ("onselectstart" in document)
      (Ft = function () {
        w(window, "selectstart", W);
      }),
        (Wt = function () {
          k(window, "selectstart", W);
        });
    else {
      var Ut = oe(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
      (Ft = function () {
        if (Ut) {
        ...
        (Wt = function () {
          Ut && ((document.documentElement.style[Ut] = Ae), (Ae = void 0));
        });
    }
    function Be() {
      w(window, "dragstart", W);
    }
    function Re() {
      k(window, "dragstart", W);
    }
    var se, Ne;
    function De(t) {
      for (; t.tabIndex === -1; ) t = t.parentNode;
      t.style &&
        (re(), (se = t), (Ne = t.style.outlineStyle), (t.style.outlineStyle = "none"), w(window, "keydown", re));
    }
    function re() {
      se && ((se.style.outlineStyle = Ne), (se = void 0), (Ne = void 0), k(window, "keydown", re));
    }
    function Ii(t) {
      do t = t.parentNode;
    ...
    function w(t, e, i, n) {
      if (e && typeof e == "object") for (var o in e) We(t, o, e[o], i);
      else {
        e = ht(e);
        for (var s = 0, r = e.length; s < r; s++) We(t, e[s], i, n);
      }
      return this;
    }
    var st = "_leaflet_events";
    function k(t, e, i, n) {
      if (arguments.length === 1) Ai(t), delete t[st];
      else if (e && typeof e == "object") for (var o in e) Ue(t, o, e[o], i);
    ...
    var Fe = { mouseenter: "mouseover", mouseleave: "mouseout", wheel: !("onwheel" in window) && "mousewheel" };
    function We(t, e, i, n) {
      var o = e + T(i) + (n ? "_" + T(n) : "");
      if (t[st] && t[st][o]) return this;
      var s = function (a) {
          return i.call(n || t, a || window.event);
        },
        r = s;
      !_.touchNative && _.pointer && e.indexOf("touch") === 0
        ? (s = Yn(t, e, s))
        : _.touch && e === "dblclick"
          ? (s = no(t, s))
          : "addEventListener" in t
            ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel"
              ? t.addEventListener(Fe[e] || e, s, _.passiveEvents ? { passive: !1 } : !1)
              : e === "mouseenter" || e === "mouseleave"
                ? ((s = function (a) {
                    (a = a || window.event), Ve(t, a) && r(a);
                  }),
    ...
    function Ge(t) {
      return We(t, "wheel", Lt), this;
    }
    function Gt(t) {
      return w(t, "mousedown touchstart dblclick contextmenu", Lt), (t._leaflet_disable_click = !0), this;
    }
    function W(t) {
      ...
      M = Bt.extend({
        ...
        initialize: function (t, e) {
          (e = E(this, e)),
            ...
            e.center && e.zoom !== void 0 && this.setView(b(e.center), e.zoom, { reset: !0 }),
            this.callInitHooks(),
            (this._zoomAnimated = Dt && _.any3d && !_.mobileOpera && this.options.zoomAnimation),
            this._zoomAnimated && (this._createAnimProxy(), w(this._proxy, Oi, this._catchTransitionEnd, this)),
        ...
        fitBounds: function (t, e) {
          if (((t = N(t)), !t.isValid())) throw new Error("Bounds are not valid.");
        ...
        panBy: function (t, e) {
          if (((t = g(t).round()), (e = e || {}), !t.x && !t.y)) return this.fire("moveend");
        ...
        flyTo: function (t, e, i) {
          if (((i = i || {}), i.animate === !1 || !_.any3d)) return this.setView(t, e, i);
          this._stop();
          ...
          function P(H) {
            var ge = H ? -1 : 1,
              Jo = H ? u : a,
              $o = u * u - a * a + ge * v * v * l * l,
              Qo = 2 * Jo * v * l,
              ii = $o / Qo,
              wn = Math.sqrt(ii * ii + 1) - ii,
              ts = wn < 1e-9 ? -18 : Math.log(wn);
            return ts;
          }
          function G(H) {
          ...
          var K = P(0);
          function It(H) {
            return a * (F(K) / F(K + c * H));
          }
          function jo(H) {
            return (a * (F(K) * tt(K + c * H) - G(K))) / v;
          }
          function Ko(H) {
          ...
          var Yo = Date.now(),
            gn = (P(1) - K) / c,
            Xo = i.duration ? 1e3 * i.duration : 1e3 * gn * 0.8;
          function yn() {
            var H = (Date.now() - Yo) / Xo,
              ge = Ko(H) * gn;
            H <= 1
              ? ((this._flyToFrame = V(yn, this)),
                this._move(
                  this.unproject(n.add(o.subtract(n).multiplyBy(jo(ge) / l)), r),
        ...
        _handleGeolocationResponse: function (t) {
          if (this._container._leaflet_id) {
            ...
            for (var u in t.coords) typeof t.coords[u] == "number" && (a[u] = t.coords[u]);
        ...
        getBoundsZoom: function (t, e, i) {
          ...
          var n = this.getZoom() || 0,
            ...
            c = _.any3d ? this.options.zoomSnap : 1,
            v = u.x / l.x,
            P = u.y / l.y,
            G = e ? Math.max(v, P) : Math.min(v, P);
          return (
        ...
        getSize: function () {
          return (
            (!this._size || this._sizeChanged) &&
              ((this._size = new y(this._container.clientWidth || 0, this._container.clientHeight || 0)),
              (this._sizeChanged = !1)),
            this._size.clone()
          );
        },
        ...
        _initContainer: function (t) {
          ...
          w(e, "scroll", this._onScroll, this), (this._containerId = T(e));
        },
        _initLayout: function () {
          var t = this._container;
          (this._fadeAnimated = this.options.fadeAnimation && _.any3d),
            x(
              t,
              "leaflet-container" +
                (_.touch ? " leaflet-touch" : "") +
                (_.retina ? " leaflet-retina" : "") +
                (_.ielt9 ? " leaflet-oldie" : "") +
                (_.safari ? " leaflet-safari" : "") +
        ...
        _initEvents: function (t) {
          ...
          e(
            ...
            _.any3d && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd);
        },
        _onResize: function () {
        ...
        _findEventTargets: function (t, e) {
          for (var i = [], n, o = e === "mouseout" || e === "mouseover", s = t.target || t.srcElement, r = !1; s; ) {
            ...
            if ((n && n.listens(e, !0) && ((o && !Ve(s, t)) || (i.push(n), o))) || s === this._container) break;
            s = s.parentNode;
          }
        ...
        _handleDOMEvent: function (t) {
          ...
          if (!(!this._loaded || e._leaflet_disable_events || (t.type === "click" && this._isClickDisabled(e)))) {
            var i = t.type;
            i === "mousedown" && De(e), this._fireDOMEvent(t, i);
          }
        },
        ...
        _fireDOMEvent: function (t, e, i) {
          ...
          if (o.length) {
            ...
            if (t.type !== "keypress" && t.type !== "keydown" && t.type !== "keyup") {
              ...
              (u.containerPoint = l ? this.latLngToContainerPoint(a.getLatLng()) : this.mouseEventToContainerPoint(t)),
                (u.layerPoint = this.containerPointToLayerPoint(u.containerPoint)),
                (u.latlng = l ? a.getLatLng() : this.layerPointToLatLng(u.layerPoint));
            }
            for (r = 0; r < o.length; r++)
              if (
                (o[r].fire(e, u, !0),
                u.originalEvent._stopped ||
                  (o[r].options.bubblingMouseEvents === !1 && we(this._mouseEvents, e) !== -1))
              )
                return;
          }
        },
        ...
        _limitZoom: function (t) {
          var e = this.getMinZoom(),
            i = this.getMaxZoom(),
            n = _.any3d ? this.options.zoomSnap : 1;
        ...
        _createAnimProxy: function () {
          var t = (this._proxy = C("div", "leaflet-proxy leaflet-zoom-animated"));
          this._panes.mapPane.appendChild(t),
            this.on(
              ...
              function (e) {
                ...
                xt(this._proxy, this.project(e.center, e.zoom), this.getZoomScale(e.zoom, 1)),
        ...
        _onZoomTransitionEnd: function () {
          this._animatingZoom &&
            (this._mapPane && A(this._mapPane, "leaflet-zoom-anim"),
    ...
    M.include({
      ...
      _initControlPos: function () {
        var t = (this._controlCorners = {}),
          e = "leaflet-",
          i = (this._controlContainer = C("div", e + "control-container", this._container));
        function n(o, s) {
          var r = e + o + " " + e + s;
          t[o + s] = C("div", r, i);
        }
    ...
    var Hi = it.extend({
        ...
        expand: function () {
          ...
          return (
            t < this._section.clientHeight
              ? (x(this._section, "leaflet-control-layers-scrollbar"), (this._section.style.height = t + "px"))
              : A(this._section, "leaflet-control-layers-scrollbar"),
        ...
        _getLayer: function (t) {
          for (var e = 0; e < this._layers.length; e++)
            if (this._layers[e] && T(this._layers[e].layer) === t) return this._layers[e];
        },
        ...
        _addItem: function (t) {
          ...
          t.overlay
            ? ((n = document.createElement("input")),
              ...
              (n.defaultChecked = i))
            : (n = this._createRadioElement("leaflet-base-layers_" + T(this), i)),
        ...
        _expandSafely: function () {
          var t = this._section;
          (this._preventClick = !0), w(t, "click", W), this.expand();
          var e = this;
          setTimeout(function () {
            k(t, "click", W), (e._preventClick = !1);
          });
        },
      }),
      lo = function (t, e, i) {
      ...
      qe = it.extend({
        ...
        _updateDisabled: function () {
          var t = this._map,
            e = "leaflet-disabled";
          A(this._zoomInButton, e),
            A(this._zoomOutButton, e),
            this._zoomInButton.setAttribute("aria-disabled", "false"),
            this._zoomOutButton.setAttribute("aria-disabled", "false"),
            (this._disabled || t._zoom === t.getMinZoom()) &&
              (x(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")),
            (this._disabled || t._zoom === t.getMaxZoom()) &&
              (x(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
        },
      });
    ...
    var co = function (t) {
      ...
      Fi = it.extend({
        ...
        _addScales: function (t, e, i) {
          t.metric && (this._mScale = C("div", e, i)), t.imperial && (this._iScale = C("div", e, i));
        },
        _update: function () {
          var t = this._map,
            e = t.getSize().y / 2,
        ...
        _updateImperial: function (t) {
          var e = t * 3.2808399,
            ...
            o;
          e > 5280
            ? ((i = e / 5280), (n = this._getRoundNum(i)), this._updateScale(this._iScale, n + " mi", n / i))
    ...
    rt.addTo = function (t, e) {
      return t.addHandler(e, this), this;
    };
    var po = { Events: Y },
      Wi = _.touch ? "touchstart mousedown" : "mousedown",
      pt = Bt.extend({
        ...
        enable: function () {
          this._enabled || (w(this._dragStartTarget, Wi, this._onDown, this), (this._enabled = !0));
        },
        disable: function () {
          this._enabled &&
            (pt._dragging === this && this.finishDrag(!0),
            k(this._dragStartTarget, Wi, this._onDown, this),
            (this._enabled = !1),
            (this._moved = !1));
        },
        _onDown: function (t) {
          if (this._enabled && ((this._moved = !1), !Ze(this._element, "leaflet-zoom-anim"))) {
            ...
            if (
              !(pt._dragging || t.shiftKey || (t.which !== 1 && t.button !== 1 && !t.touches)) &&
              ((pt._dragging = this), this._preventOutline && De(this._element), Be(), Ft(), !this._moving)
            ) {
              this.fire("down");
        ...
        finishDrag: function (t) {
          A(document.body, "leaflet-dragging"),
            this._lastTarget && (A(this._lastTarget, "leaflet-drag-target"), (this._lastTarget = null)),
    ...
    function Ui(t, e, i) {
      var n,
        ...
        v,
        P;
      for (s = 0, c = t.length; s < c; s++) t[s]._code = bt(t[s], e);
      for (a = 0; a < 4; a++) {
        for (v = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
          (u = t[s]),
            (l = t[r]),
            u._code & v
              ? l._code & v || ((P = ae(l, u, v, e, i)), (P._code = bt(P, e)), n.push(P))
              : (l._code & v && ((P = ae(l, u, v, e, i)), (P._code = bt(P, e)), n.push(P)), n.push(u));
        t = n;
      }
      return t;
    }
    function Gi(t, e) {
      ...
      var v = b([0, 0]),
        P = N(t),
        G = P.getNorthWest().distanceTo(P.getSouthWest()) * P.getNorthEast().distanceTo(P.getNorthWest());
      G < 1700 && (v = Ke(t));
      var F = t.length,
        tt = [];
      for (i = 0; i < F; i++) {
        var K = b(t[i]);
        tt.push(e.project(b([K.lat - v.lat, K.lng - v.lng])));
      }
      for (a = u = l = 0, i = 0, n = F - 1; i < F; n = i++)
        (o = tt[i]),
          (s = tt[n]),
          (r = o.y * s.x - s.y * o.x),
          (u += (o.x + s.x) * r),
          (l += (o.y + s.y) * r),
          (a += r * 3);
      a === 0 ? (c = tt[0]) : (c = [u / a, l / a]);
      var It = e.unproject(g(c));
      return b([It.lat + v.lat, It.lng + v.lng]);
    }
    function Ke(t) {
    ...
    var vo = { __proto__: null, clipPolygon: Ui, polygonCenter: Gi, centroid: Ke };
    function Vi(t, e) {
      if (!e || !t.length) return t.slice();
      var i = e * e;
      return (t = wo(t, i)), (t = yo(t, i)), t;
    }
    function qi(t, e, i) {
    ...
    function Ye(t, e, i, n, o) {
      var s = 0,
        ...
        a,
        u;
      for (a = n + 1; a <= o - 1; a++) (u = qt(t[a], t[n], t[o], !0)), u > s && ((r = a), (s = u));
    ...
    function Ki(t, e, i, n, o) {
      ...
      for (ji = r; ; ) {
        if (!(s | r)) return [t, e];
        if (s & r) return !1;
        (a = s || r), (u = ae(t, e, a, i, o)), (l = bt(u, i)), a === s ? ((t = u), (s = l)) : ((e = u), (r = l));
      }
    }
    ...
    function Xi(t, e) {
      ...
      var c = b([0, 0]),
        v = N(t),
        P = v.getNorthWest().distanceTo(v.getSouthWest()) * v.getNorthEast().distanceTo(v.getNorthWest());
      P < 1700 && (c = Ke(t));
      var G = t.length,
        F = [];
      for (i = 0; i < G; i++) {
        var tt = b(t[i]);
        F.push(e.project(b([tt.lat - c.lat, tt.lng - c.lng])));
      }
      for (i = 0, n = 0; i < G - 1; i++) n += F[i].distanceTo(F[i + 1]) / 2;
      if (n === 0) l = F[0];
      else
        for (i = 0, s = 0; i < G - 1; i++)
          if (((r = F[i]), (a = F[i + 1]), (o = r.distanceTo(a)), (s += o), s > n)) {
            (u = (s - n) / o), (l = [a.x - u * (a.x - r.x), a.y - u * (a.y - r.y)]);
            break;
          }
      var K = e.unproject(g(l));
    ...
    var Po = {
      ...
      Lo = { __proto__: null, LonLat: Xe, Mercator: Je, SphericalMercator: Le },
      To = d({}, mt, {
        code: "EPSG:3395",
        projection: Je,
        transformation: (function () {
      ...
      Ji = d({}, mt, { code: "EPSG:4326", projection: Xe, transformation: Rt(1 / 180, 1, -1 / 180, 0.5) }),
      bo = d({}, lt, {
        projection: Xe,
    ...
    (lt.Earth = mt), (lt.EPSG3395 = To), (lt.EPSG3857 = be), (lt.EPSG900913 = En), (lt.EPSG4326 = Ji), (lt.Simple = bo);
    var nt = Bt.extend({
    ...
    var zt = nt.extend({
      ...
      ct = zt.extend({
        addLayer: function (t) {
          return this.hasLayer(t)
            ? this
            : (t.addEventParent(this), zt.prototype.addLayer.call(this, t), this.fire("layeradd", { layer: t }));
        },
        removeLayer: function (t) {
          return this.hasLayer(t)
      ...
      Et = ut.extend({
        ...
        _setIconStyles: function (t, e) {
          ...
          var o = g(n),
            s = g((e === "shadow" && i.shadowAnchor) || i.iconAnchor || (o && o.divideBy(2, !0)));
    ...
    var jt = Et.extend({
        ...
        _getIconUrl: function (t) {
          return (
            typeof jt.imagePath != "string" && (jt.imagePath = this._detectIconPath()),
            (this.options.imagePath || jt.imagePath) + Et.prototype._getIconUrl.call(this, t)
          );
        },
      ...
      $i = rt.extend({
        ...
        removeHooks: function () {
          this._draggable
            ...
            .disable(),
            this._marker._icon && A(this._marker._icon, "leaflet-marker-draggable");
        },
        moved: function () {
        ...
        _adjustPan: function (t) {
          var e = this._marker,
            ...
            r = i.getPixelBounds(),
            a = i.getPixelOrigin(),
            u = q(r.min._subtract(a).add(o), r.max._subtract(a).subtract(o));
          if (!u.contains(s)) {
            var l = g(
      ...
      he = nt.extend({
        ...
        _initInteraction: function () {
          if (
            ...
            (x(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), $i)
          ) {
            var t = this.options.draggable;
            this.dragging && ((t = this.dragging.enabled()), this.dragging.disable()),
              (this.dragging = new $i(this)),
    ...
    var vt = nt.extend({
      ...
      ue = vt.extend({
        ...
        initialize: function (t, e) {
          E(this, e), (this._latlng = b(t)), (this._radius = this.options.radius);
        },
        setLatLng: function (t) {
          var e = this._latlng;
      ...
      _project: function () {
        ...
        if (n.distance === mt.distance) {
          var o = Math.PI / 180,
            ...
            l = i.unproject(u).lat,
            c =
              Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(l * o)) / (Math.cos(e * o) * Math.cos(l * o))) /
              o;
    ...
    var ft = vt.extend({
      ...
      _projectLatlngs: function (t, e, i) {
        var n = t[0] instanceof z,
          o = t.length,
          s,
          r;
        if (n) {
          for (r = [], s = 0; s < o; s++) (r[s] = this._map.latLngToLayerPoint(t[s])), i.extend(r[s]);
          e.push(r);
        ...
        if (((this._parts = []), !(!this._pxBounds || !this._pxBounds.intersects(t)))) {
          ...
          for (i = 0, o = 0, s = this._rings.length; i < s; i++)
            for (u = this._rings[i], n = 0, r = u.length; n < r - 1; n++)
              (a = Ki(u[n], u[n + 1], t, n, !0)),
                a &&
                  ((e[o] = e[o] || []), e[o].push(a[0]), (a[1] !== u[n + 1] || n === r - 2) && (e[o].push(a[1]), o++));
        }
      },
      _simplifyPoints: function () {
        for (var t = this._parts, e = this.options.smoothFactor, i = 0, n = t.length; i < n; i++) t[i] = Vi(t[i], e);
      },
      _update: function () {
      ...
      _containsPoint: function (t, e) {
        ...
        for (i = 0, s = this._parts.length; i < s; i++)
          for (a = this._parts[i], n = 0, r = a.length, o = r - 1; n < r; o = n++)
            if (!(!e && n === 0) && qi(t, a[o], a[n]) <= u) return !0;
        return !1;
      },
    });
    function Oo(t, e) {
    ...
    var kt = ft.extend({
      ...
      _convertLatLngs: function (t) {
        var e = ft.prototype._convertLatLngs.call(this, t),
          i = e.length;
        return i >= 2 && e[0] instanceof z && e[0].equals(e[i - 1]) && e.pop(), e;
      },
      _setLatLngs: function (t) {
        ft.prototype._setLatLngs.call(this, t), Q(this._latlngs) && (this._latlngs = [this._latlngs]);
      },
      _defaultShape: function () {
      ...
      _containsPoint: function (t) {
        ...
        return e || ft.prototype._containsPoint.call(this, t, !0);
      },
    });
    function Zo(t, e) {
      return new kt(t, e);
    ...
    function le(t, e) {
      ...
      switch (i.type) {
        ...
        case "MultiPoint":
          for (l = 0, c = n.length; l < c; l++) (a = r(n[l])), o.push(Qi(s, t, a, e));
          return new ct(o);
        case "LineString":
        case "MultiLineString":
          return (u = ce(n, i.type === "LineString" ? 0 : 1, r)), new ft(u, e);
        case "Polygon":
        case "MultiPolygon":
          return (u = ce(n, i.type === "Polygon" ? 1 : 2, r)), new kt(u, e);
        case "GeometryCollection":
          for (l = 0, c = i.geometries.length; l < c; l++) {
            var v = le({ geometry: i.geometries[l], type: "Feature", properties: t.properties }, e);
            v && o.push(v);
          }
          return new ct(o);
        case "FeatureCollection":
          for (l = 0, c = i.features.length; l < c; l++) {
            var P = le(i.features[l], e);
            P && o.push(P);
          }
          return new ct(o);
        default:
    ...
    function Qi(t, e, i, n) {
      return t ? t(e, i) : new he(i, n && n.markersInheritOptions && n);
    }
    function Qe(t) {
      return new z(t[1], t[0], t[2]);
    }
    function ce(t, e, i) {
      for (var n = [], o = 0, s = t.length, r; o < s; o++) (r = e ? ce(t[o], e - 1, i) : (i || Qe)(t[o])), n.push(r);
      return n;
    }
    function ti(t, e) {
      return (t = b(t)), t.alt !== void 0 ? [X(t.lng, e), X(t.lat, e), X(t.alt, e)] : [X(t.lng, e), X(t.lat, e)];
    }
    function fe(t, e, i, n) {
      for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? fe(t[s], Q(t[s]) ? 0 : e - 1, i, n) : ti(t[s], n));
      return !e && i && o.length > 0 && o.push(o[0].slice()), o;
    }
    function Ot(t, e) {
      return t.feature ? d({}, t.feature, { geometry: e }) : de(e);
    }
    function de(t) {
    ...
    var ei = {
      toGeoJSON: function (t) {
        return Ot(this, { type: "Point", coordinates: ti(this.getLatLng(), t) });
      },
    };
    he.include(ei),
      $e.include(ei),
      ...
      kt.include({
        toGeoJSON: function (t) {
          var e = !Q(this._latlngs),
            ...
            n = fe(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
          return e || (n = [n]), Ot(this, { type: (i ? "Multi" : "") + "Polygon", coordinates: n });
        },
      }),
      zt.include({
        ...
        toGeoJSON: function (t) {
          ...
          return (
            ...
            i ? Ot(this, { geometries: n, type: "GeometryCollection" }) : { type: "FeatureCollection", features: n }
          );
        },
      });
    function tn(t, e) {
    ...
    var Io = tn,
      _e = nt.extend({
        ...
        initialize: function (t, e, i) {
          (this._url = t), (this._bounds = N(e)), E(this, i);
        },
        onAdd: function () {
          this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
            this.options.interactive && (x(this._image, "leaflet-interactive"), this.addInteractiveTarget(this._image)),
    ...
    var at = nt.extend({
      ...
      initialize: function (t, e) {
        t && (t instanceof z || et(t)) ? ((this._latlng = b(t)), E(this, e)) : (E(this, t), (this._source = e)),
      ...
      onAdd: function (t) {
        (this._zoomAnimated = t._zoomAnimated),
          ...
          this.bringToFront(),
          this.options.interactive &&
            (x(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container));
      },
      onRemove: function (t) {
        t._fadeAnimated
          ? ($(this._container, 0), (this._removeTimeout = setTimeout(S(I, void 0, this._container), 200)))
          : I(this._container),
          this.options.interactive &&
            (A(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
      },
      getLatLng: function () {
        return this._latlng;
      },
    ...
    M.include({
      ...
      nt.include({
        _initOverlay: function (t, e, i, n) {
          var o = i;
          return (
            o instanceof t ? (E(o, n), (o._source = this)) : ((o = e && !n ? e : new t(n, this)), o.setContent(i)), o
          );
        },
      });
    var me = at.extend({
        ...
        openOn: function (t) {
          return (
            ...
            (t._popup = this),
            at.prototype.openOn.call(this, t)
          );
        },
        onAdd: function (t) {
          at.prototype.onAdd.call(this, t),
            t.fire("popupopen", { popup: this }),
            this._source &&
              (this._source.fire("popupopen", { popup: this }, !0),
              this._source instanceof vt || this._source.on("preclick", Lt));
        },
        onRemove: function (t) {
          at.prototype.onRemove.call(this, t),
            t.fire("popupclose", { popup: this }),
            this._source &&
              (this._source.fire("popupclose", { popup: this }, !0),
              this._source instanceof vt || this._source.off("preclick", Lt));
        },
        getEvents: function () {
          var t = at.prototype.getEvents.call(this);
          return (
            (this.options.closeOnClick !== void 0 ? this.options.closeOnClick : this._map.options.closePopupOnClick) &&
        ...
        _initLayout: function () {
          var t = "leaflet-popup",
            e = (this._container = C("div", t + " " + (this.options.className || "") + " leaflet-zoom-animated")),
        ...
        _updateLayout: function () {
          ...
          o && n > o ? ((e.height = o + "px"), x(t, s)) : A(t, s), (this._containerWidth = this._container.offsetWidth);
        },
        _animateZoom: function (t) {
        ...
        _adjustPan: function () {
          if (this.options.autoPan) {
            ...
            s.x + n + u.x > l.x && (c = s.x + n - l.x + u.x),
              ...
              (c || v) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([c, v]));
          }
        },
        _getAnchor: function () {
    ...
    M.mergeOptions({ closePopupOnClick: !0 }),
      ...
      nt.include({
        bindPopup: function (t, e) {
          return (
            (this._popup = this._initOverlay(me, this._popup, t, e)),
        ...
        openPopup: function (t) {
          return (
            this._popup &&
              (this instanceof ct || (this._popup._source = this),
    ...
    var pe = at.extend({
        ...
        _initLayout: function () {
          var t = "leaflet-tooltip",
            e =
              t + " " + (this.options.className || "") + " leaflet-zoom-" + (this._zoomAnimated ? "animated" : "hide");
        ...
        _setPosition: function (t) {
          ...
          a === "top"
            ...
            (t = t
              ...
              .add(c)
              .add(v)),
            A(o, "leaflet-tooltip-right"),
            A(o, "leaflet-tooltip-left"),
            A(o, "leaflet-tooltip-top"),
            A(o, "leaflet-tooltip-bottom"),
      ...
      nt.include({
        bindTooltip: function (t, e) {
          return (
            ...
            (this._tooltip = this._initOverlay(pe, this._tooltip, t, e)),
        ...
        openTooltip: function (t) {
          return (
            this._tooltip &&
              (this instanceof ct || (this._tooltip._source = this),
    ...
    var on = Et.extend({
      ...
      createIcon: function (t) {
        var e = t && t.tagName === "DIV" ? t : document.createElement("div"),
          i = this.options;
        if (
          (i.html instanceof Element ? (ie(e), e.appendChild(i.html)) : (e.innerHTML = i.html !== !1 ? i.html : ""),
          i.bgPos)
        ) {
          var n = g(i.bgPos);
    ...
    var Kt = nt.extend({
      ...
      getEvents: function () {
        ...
        return (
          this.options.updateWhenIdle ||
            (this._onMove || (this._onMove = At(this._onMoveEnd, this.options.updateInterval, this)),
            (t.move = this._onMove)),
      ...
      _updateOpacity: function () {
        if (this._map && !_.ielt9) {
          ...
          i && !this._noPrune && this._pruneTiles(),
            e && (J(this._fadeFrame), (this._fadeFrame = V(this._updateOpacity, this)));
        }
      },
      _onOpaqueTile: O,
      _initContainer: function () {
        this._container ||
          ((this._container = C("div", "leaflet-layer " + (this.options.className || ""))),
          this._updateZIndex(),
          ...
          for (var i in this._levels)
            (i = Number(i)),
              this._levels[i].el.children.length || i === t
                ...
                : (I(this._levels[i].el), this._removeTilesAtZoom(i), this._onRemoveLevel(i), delete this._levels[i]);
          var n = this._levels[t],
            o = this._map;
          return (
            n ||
              ((n = this._levels[t] = {}),
              (n.el = C("div", "leaflet-tile-container leaflet-zoom-animated", this._container)),
              (n.el.style.zIndex = e),
      ...
      _invalidateAll: function () {
        for (var t in this._levels) I(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this._levels[t];
        ...
        if (e) {
          ...
          if ((t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0)) {
            var n = this._getTiledPixelBounds(t),
              ...
              u = new Z(o.getBottomLeft().subtract([a, -a]), o.getTopRight().add([a, -a]));
            if (!(isFinite(o.min.x) && isFinite(o.min.y) && isFinite(o.max.x) && isFinite(o.max.y)))
              throw new Error("Attempted to load an infinite number of tiles");
            for (var l in this._tiles) {
              var c = this._tiles[l].coords;
              (c.z !== this._tileZoom || !u.contains(new y(c.x, c.y))) && (this._tiles[l].current = !1);
            }
            ...
            for (var v = o.min.y; v <= o.max.y; v++)
              for (var P = o.min.x; P <= o.max.x; P++) {
                ...
                if (((G.z = this._tileZoom), !!this._isValidTile(G))) {
                  var F = this._tiles[this._tileCoordsToKey(G)];
                  F ? (F.current = !0) : r.push(G);
                }
              }
            if (
              (r.sort(function (K, It) {
                return K.distanceTo(s) - It.distanceTo(s);
              }),
              r.length !== 0)
            ) {
              this._loading || ((this._loading = !0), this.fire("loading"));
              var tt = document.createDocumentFragment();
              for (P = 0; P < r.length; P++) this._addTile(r[P], tt);
      ...
      _removeTile: function (t) {
        var e = this._tiles[t];
        e &&
          (I(e.el), delete this._tiles[t], this.fire("tileunload", { tile: e.el, coords: this._keyToTileCoords(t) }));
      },
      _initTile: function (t) {
        ...
        (t.style.width = e.x + "px"),
          ...
          (t.onselectstart = O),
          (t.onmousemove = O),
          _.ielt9 && this.options.opacity < 1 && $(t, this.options.opacity);
      },
      _addTile: function (t, e) {
        ...
        this._initTile(o),
          this.createTile.length < 2 && V(S(this._tileReady, this, t, null, o)),
          D(o, i),
        ...
        (i = this._tiles[n]),
          i &&
            ...
            this._map._fadeAnimated
              ? ($(i.el, 0), J(this._fadeFrame), (this._fadeFrame = V(this._updateOpacity, this)))
              : ((i.active = !0), this._pruneTiles()),
            e || (x(i.el, "leaflet-tile-loaded"), this.fire("tileload", { tile: i.el, coords: t })),
            this._noTilesToLoad() &&
              ((this._loading = !1),
              this.fire("load"),
              _.ielt9 || !this._map._fadeAnimated
      ...
      _wrapCoords: function (t) {
        var e = new y(this._wrapX ? yt(t.x, this._wrapX) : t.x, this._wrapY ? yt(t.y, this._wrapY) : t.y);
        return (e.z = t.z), e;
      },
    ...
    var Zt = Kt.extend({
      ...
      initialize: function (t, e) {
        (this._url = t),
          (e = E(this, e)),
          e.detectRetina && _.retina && e.maxZoom > 0
      ...
      createTile: function (t, e) {
        ...
        return (
          w(i, "load", S(this._tileOnLoad, this, e, i)),
          w(i, "error", S(this._tileOnError, this, e, i)),
          (this.options.crossOrigin || this.options.crossOrigin === "") &&
      ...
      _tileOnLoad: function (t, e) {
        _.ielt9 ? setTimeout(S(t, this, null, e), 0) : t(null, e);
      },
      ...
      _abortLoading: function () {
        ...
        for (t in this._tiles)
          if (
            ...
            ((e = this._tiles[t].el), (e.onload = O), (e.onerror = O), !e.complete)
          ) {
            e.src = Qt;
            var i = this._tiles[t].coords;
            I(e), delete this._tiles[t], this.fire("tileabort", { tile: e, coords: i });
          }
      },
      _removeTile: function (t) {
        var e = this._tiles[t];
        if (e) return e.el.setAttribute("src", Qt), Kt.prototype._removeTile.call(this, t);
      },
      _tileReady: function (t, e, i) {
        if (!(!this._map || (i && i.getAttribute("src") === Qt))) return Kt.prototype._tileReady.call(this, t, e, i);
      },
    });
    function sn(t, e) {
      return new Zt(t, e);
    ...
    var rn = Zt.extend({
      ...
      initialize: function (t, e) {
        ...
        e = E(this, e);
        var o = e.detectRetina && _.retina ? 2 : 1,
          s = this.getTileSize();
      ...
      getTileUrl: function (t) {
        var e = this._tileCoordsToNwSe(t),
          ...
          o = n.min,
          s = n.max,
          r = (this._wmsVersion >= 1.3 && this._crs === Ji ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","),
          a = Zt.prototype.getTileUrl.call(this, t);
        return a + Jt(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r;
      },
    ...
    var _t = nt.extend({
        options: { padding: 0.1 },
        initialize: function (t) {
          E(this, t), T(this), (this._layers = this._layers || {});
        },
        onAdd: function () {
          this._container || (this._initContainer(), x(this._container, "leaflet-zoom-animated")),
            this.getPane().appendChild(this._container),
            this._update(),
      ...
      an = _t.extend({
        ...
        _destroyContainer: function () {
          J(this._redrawRequest), delete this._ctx, I(this._container), k(this._container), delete this._container;
        },
        _updatePaths: function () {
        ...
        _update: function () {
          if (!(this._map._animatingZoom && this._bounds)) {
            ...
            D(e, t.min),
              ...
              _.retina && this._ctx.scale(2, 2),
              this._ctx.translate(-t.min.x, -t.min.y),
              this.fire("update");
          }
        },
        _reset: function () {
          _t.prototype._reset.call(this),
        ...
        _requestRedraw: function (t) {
          this._map &&
            (this._extendRedrawBounds(t), (this._redrawRequest = this._redrawRequest || V(this._redraw, this)));
        },
          ...
          if (this._drawing) {
            ...
            if (a) {
              for (u.beginPath(), i = 0; i < a; i++) {
                for (n = 0, o = r[i].length; n < o; n++) (s = r[i][n]), u[n ? "lineTo" : "moveTo"](s.x, s.y);
                e && u.closePath();
              }
        ...
        _handleMouseOut: function (t) {
          ...
          e &&
            (A(this._container, "leaflet-interactive"),
    ...
    var Yt = (function () {
      ...
      Uo = {
        ...
        _updateStyle: function (t) {
          ...
          (o.stroked = !!n.stroke),
            (o.filled = !!n.fill),
            n.stroke
              ? (e || (e = t._stroke = Yt("stroke")),
                o.appendChild(e),
                (e.weight = n.weight + "px"),
                (e.color = n.color),
                (e.opacity = n.opacity),
                n.dashArray
                  ? (e.dashStyle = et(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " "))
                  : (e.dashStyle = ""),
      ...
      Xt = _t.extend({
        ...
        _destroyContainer: function () {
          I(this._container), k(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
        },
        _update: function () {
          if (!(this._map._animatingZoom && this._bounds)) {
            _t.prototype._update.call(this);
        ...
        _removePath: function (t) {
          I(t._path), t.removeInteractiveTarget(t._path), delete this._layers[T(t)];
        },
        _updatePath: function (t) {
    ...
    _.vml && Xt.include(Uo);
    function un(t) {
      return _.svg || _.vml ? new Xt(t) : null;
    }
    M.include({
      ...
      _createRenderer: function (t) {
        return (this.options.preferCanvas && hn(t)) || un(t);
      },
    });
    var ln = kt.extend({
      initialize: function (t, e) {
    ...
    (Xt.create = ve),
      (Xt.pointsToPath = fi),
      (dt.geometryToLayer = le),
      (dt.coordsToLatLng = Qe),
      (dt.coordsToLatLngs = ce),
      (dt.latLngToCoords = ti),
      (dt.latLngsToCoords = fe),
      (dt.getFeature = Ot),
      (dt.asFeature = de),
    ...
    var cn = rt.extend({
      ...
      _onMouseDown: function (t) {
        ...
        this._clearDeferredResetState(),
          ...
          w(
            document,
            { contextmenu: Tt, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown },
            this,
          );
      },
      _onMouseMove: function (t) {
      ...
      _finish: function () {
        this._moved && (I(this._box), A(this._container, "leaflet-crosshair")),
          Wt(),
          Re(),
          k(
            document,
    ...
    M.addInitHook("addHandler", "boxZoom", cn), M.mergeOptions({ doubleClickZoom: !0 });
    var fn = rt.extend({
      addHooks: function () {
    ...
    M.addInitHook("addHandler", "doubleClickZoom", fn),
      M.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    var dn = rt.extend({
      ...
      removeHooks: function () {
        A(this._map._container, "leaflet-grab"),
          A(this._map._container, "leaflet-touch-drag"),
      ...
      _onDragEnd: function (t) {
        ...
        if ((e.fire("dragend", t), n)) e.fire("moveend");
          ...
          var o = this._lastPos.subtract(this._positions[0]),
            ...
            P = c.multiplyBy(-v / 2).round();
          !P.x && !P.y
            ? e.fire("moveend")
            : ((P = e._limitOffset(P, e.options.maxBounds)),
              V(function () {
                e.panBy(P, { duration: v, easeLinearity: r, noMoveStart: !0, animate: !0 });
              }));
        }
      },
    });
    M.addInitHook("addHandler", "dragging", dn), M.mergeOptions({ keyboard: !0, keyboardPanDelta: 80 });
    var _n = rt.extend({
      keyCodes: {
        left: [37],
        right: [39],
      ...
      addHooks: function () {
        ...
        t.tabIndex <= 0 && (t.tabIndex = "0"),
          w(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this),
          ...
          if (e in this._panKeys) {
            if (!i._panAnim || !i._panAnim._inProgress)
              if (
                ...
                i.options.maxBounds && (n = i._limitOffset(g(n), i.options.maxBounds)),
    ...
    M.addInitHook("addHandler", "keyboard", _n),
      M.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 });
    var mn = rt.extend({
      addHooks: function () {
      ...
      _onWheelScroll: function (t) {
        ...
        clearTimeout(this._timer), (this._timer = setTimeout(S(this._performZoom, this), n)), Tt(t);
      },
      _performZoom: function () {
        ...
        (this._delta = 0),
          ...
          r && (t.options.scrollWheelZoom === "center" ? t.setZoom(e + r) : t.setZoomAround(this._lastMousePos, e + r));
      },
    });
    M.addInitHook("addHandler", "scrollWheelZoom", mn);
    var Vo = 600;
    M.mergeOptions({ tapHold: _.touchNative && _.safari && _.mobile, tapTolerance: 15 });
    var pn = rt.extend({
      addHooks: function () {
      ...
      _cancelClickPrevent: function t() {
        k(document, "touchend", W), k(document, "touchend touchcancel", t);
      },
      _cancel: function () {
    ...
    M.addInitHook("addHandler", "tapHold", pn), M.mergeOptions({ touchZoom: _.touch, bounceAtZoomLimits: !0 });
    var vn = rt.extend({
      addHooks: function () {
        x(this._map._container, "leaflet-touch-zoom"), w(this._map._container, "touchstart", this._onTouchStart, this);
      },
      removeHooks: function () {
        A(this._map._container, "leaflet-touch-zoom"), k(this._map._container, "touchstart", this._onTouchStart, this);
      },
      ...
      _onTouchMove: function (t) {
        if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
          ...
          (this._animRequest = V(r, this, !0)), W(t);
        }
      },
    ...
    M.addInitHook("addHandler", "touchZoom", vn),
      (M.BoxZoom = cn),
      (M.DoubleClickZoom = fn),
      (M.Drag = dn),
      (M.Keyboard = _n),
      (M.ScrollWheelZoom = mn),
      (M.TapHold = pn),
      (M.TouchZoom = vn),
      (h.Bounds = Z),
      (h.Browser = _),
  ...
  B.useEffect(
    function () {
      f !== h.current &&
        ...
        (h.current != null && m.attributionControl.removeAttribution(h.current),
        f != null && m.attributionControl.addAttribution(f)),
        (h.current = f);
    },
    [m, f],
  );
...
const os = 1;
function ss(m) {
  return Object.freeze({ __version: os, map: m });
}
function rs(m, f) {
  return Object.freeze({ ...m, ...f });
}
const xn = B.createContext(null),
  Pn = xn.Provider;
function Ln() {
  const m = B.useContext(xn);
  if (m == null)
...
function as(m) {
  function f(h, p) {
    const { instance: d, context: R } = m(h).current;
    return (
      B.useImperativeHandle(p, () => d), h.children == null ? null : ni.createElement(Pn, { value: R }, h.children)
    );
  }
  return B.forwardRef(f);
}
function hs(m) {
  function f(h, p) {
    const { instance: d } = m(h).current;
    return B.useImperativeHandle(p, () => d), null;
  }
  return B.forwardRef(f);
}
function us(m, f) {
...
function Tn(m, f) {
  const h = m.pane ?? f.pane;
  return h ? { ...m, pane: h } : m;
}
function bn(m, f, h) {
  return Object.freeze({ instance: m, context: f, container: h });
}
function Mn(m, f) {
  return f == null
    ? function (p, d) {
        const R = B.useRef();
        return R.current || (R.current = m(p, d)), R;
      }
    : function (p, d) {
        const R = B.useRef();
        R.current || (R.current = m(p, d));
        const S = B.useRef(p),
          { instance: gt } = R.current;
        return (
          B.useEffect(
            function () {
              S.current !== p && (f(gt, p, S.current), (S.current = p));
            },
            [gt, p, d],
          ),
          R
...
function ls(m, f) {
  B.useEffect(
    function () {
      return (
        (f.layerContainer ?? f.map).addLayer(m.instance),
        function () {
          var R;
          (R = f.layerContainer) == null || R.removeLayer(m.instance), f.map.removeLayer(m.instance);
        }
      );
    },
    [f, m],
...
function Cn(m) {
  return function (h) {
    const p = Ln(),
      d = m(Tn(h, p), p);
    return ns(p.map, h.attribution), us(d.current, h.eventHandlers), ls(d.current, p), d;
  };
}
function cs(m, f) {
  const h = Mn(m, f),
...
function ds(m, f, h) {
  ...
  p != null && p !== h.opacity && m.setOpacity(p), d != null && d !== h.zIndex && m.setZIndex(d);
}
function gs() {
  return Ln().map;
}
    ...
    (si =
      ...
      function (m) {
        for (var f = 1; f < arguments.length; f++) {
          var h = arguments[f];
          for (var p in h) Object.prototype.hasOwnProperty.call(h, p) && (m[p] = h[p]);
        }
        return m;
      }),
...
function _s(
  ...
  const [X] = B.useState({ className: d, id: R, style: gt }),
    [U, ht] = B.useState(null);
  B.useImperativeHandle(O, () => (U == null ? void 0 : U.map) ?? null, [U]);
  const E = B.useCallback(($t) => {
    if ($t !== null && U === null) {
      const wt = new ye.Map($t, yt);
      h != null && At != null ? wt.setView(h, At) : m != null && wt.fitBounds(m, f),
        T != null && wt.whenReady(T),
        ht(ss(wt));
    }
  }, []);
  B.useEffect(
  ...
  const Jt = U ? ni.createElement(Pn, { value: U }, p) : S ?? null;
  return ni.createElement("div", si({}, X, { ref: E }), Jt);
}
const ys = B.forwardRef(_s),
  ws = cs(
    function ({ position: f, ...h }, p) {
      const d = new ye.Marker(f, h);
      return bn(d, rs(p, { overlayContainer: d }));
    },
    function (f, h, p) {
      h.position !== p.position && f.setLatLng(h.position),
        h.icon != null && h.icon !== p.icon && f.setIcon(h.icon),
        h.zIndexOffset != null && h.zIndexOffset !== p.zIndexOffset && f.setZIndexOffset(h.zIndexOffset),
  ...
  xs = fs(
    function ({ url: f, ...h }, p) {
      const d = new ye.TileLayer(f, Tn(h, p));
      return bn(d, p);
    },
    function (f, h, p) {
      ds(f, h, p);
...
export { vs as L, ys as M, xs as T, ws as a, gs as u };
